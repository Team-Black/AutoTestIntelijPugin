...
public class OtherSettingsConfigurableGUI {

    private JPanel rootPanel;
    private JTextField exeNameTextField;

    OtherSettingsConfigurableGUI() {
...
// >>> IMPORTANT!! <<<
    ...
    private void $$$setupUI$$$() {
        ...
        rootPanel.setLayout(new GridLayoutManager(3, 2 ,
                                                    new Insets(0, 0, 0, 0), -1, -1));
        rootPanel.setRequestFocusEnabled(true);
        final JLabel label1 = new JLabel();
        label1.setText("Executable name");
        rootPanel.add(label1, new GridConstraints(
                0, 0, 1, 1, GridConstraints.ANCHOR_NORTHWEST, GridConstraints.FILL_NONE,
        ...
        rootPanel.add(exeNameTextField, new GridConstraints(0, 1, 1, 1,
        ...
        rootPanel.add(label2, new GridConstraints(1, 1, 1, 1,
        ...
        rootPanel.add(spacer1, new GridConstraints(2, 0, 1, 1,
